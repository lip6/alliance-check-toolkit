...
def _setup_techno ( coriolisTechDir ):
    ...
    createBL( tech, 'activ.pin'  , BasicLayer.Material.other   ,                                             gds2Layer= 65, gds2DataType= 16 )
    createBL( tech, 'activ.block', BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType= 10 )
    ...
    createBL( tech, 'M1.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 67, gds2DataType= 16 )
    createBL( tech, 'M1.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType= 40 )
    createBL( tech, 'M2.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 68, gds2DataType= 16 )
    createBL( tech, 'M2.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType= 60 )
    createBL( tech, 'M3.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 69, gds2DataType= 16 )
    createBL( tech, 'M3.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType= 80 )
    createBL( tech, 'M4.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 70, gds2DataType= 16 )
    createBL( tech, 'M4.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType=100 )
    createBL( tech, 'M5.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 71, gds2DataType= 16 )
    createBL( tech, 'M5.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType=120 )
    createBL( tech, 'M6.pin'       , BasicLayer.Material.other   ,                                             gds2Layer= 72, gds2DataType= 16 )
    createBL( tech, 'M6.block'     , BasicLayer.Material.blockage,                                             gds2Layer=100, gds2DataType=140 )
    ...
    createBL( tech, 'activ'        , BasicLayer.Material.active  , size=u(0.15), spacing=u(0.27),              gds2Layer= 65, gds2DataType= 20 )
    createBL( tech, 'poly'         , BasicLayer.Material.poly    , size=u(0.15), spacing=u(0.21),              gds2Layer= 66, gds2DataType= 20 )
    createBL( tech, 'cont'         , BasicLayer.Material.cut     , size=u(0.17), spacing=u(0.17),              gds2Layer= 66, gds2DataType= 44 )
    createBL( tech, 'M1'           , BasicLayer.Material.metal   , size=u(0.17), spacing=u(0.17),              gds2Layer= 67, gds2DataType= 20 )
    createBL( tech, 'via12'         , BasicLayer.Material.cut     , size=u(0.17), spacing=u(0.19),              gds2Layer= 67, gds2DataType= 44 )
    createBL( tech, 'M2'           , BasicLayer.Material.metal   , size=u(0.14), spacing=u(0.14), area=0.083,  gds2Layer= 68, gds2DataType= 20 )
    createBL( tech, 'via23'          , BasicLayer.Material.cut     , size=u(0.15), spacing=u(0.17),              gds2Layer= 68, gds2DataType= 44 )
    createBL( tech, 'M3'           , BasicLayer.Material.metal   , size=u(0.14), spacing=u(0.14), area=0.0676, gds2Layer= 69, gds2DataType= 20 )
    createBL( tech, 'capm'         , BasicLayer.Material.metal )
    createBL( tech, 'via34'         , BasicLayer.Material.cut     , size=u(0.2 ), spacing=u(0.2 ),              gds2Layer= 69, gds2DataType= 44 )
    createBL( tech, 'M4'           , BasicLayer.Material.metal   , size=u(0.3 ), spacing=u(0.3 ), area=0.24,   gds2Layer= 70, gds2DataType= 20 )
    createBL( tech, 'via45'         , BasicLayer.Material.cut     , size=u(0.2 ), spacing=u(0.2 ),              gds2Layer= 70, gds2DataType= 44 )
    createBL( tech, 'M5'           , BasicLayer.Material.metal   , size=u(0.3 ), spacing=u(0.3 ), area=0.24,   gds2Layer= 71, gds2DataType= 20 )
    createBL( tech, 'via56'         , BasicLayer.Material.cut     , size=u(0.8 ), spacing=u(0.8 ),              gds2Layer= 71, gds2DataType= 44 )
    createBL( tech, 'M6'           , BasicLayer.Material.metal   , size=u(1.6 ), spacing=u(1.6 ), area=4.0,    gds2Layer= 72, gds2DataType= 20 )
    ...
    # Blockages
    tech.getLayer('activ'  ).setBlockageLayer( tech.getLayer('activ.block') )
    ...
    tech.getLayer('M6')     .setBlockageLayer( tech.getLayer('M6.block') )
    tech.getLayer('cont' )  .setBlockageLayer( tech.getLayer('cont.block') )
    tech.getLayer('via12')   .setBlockageLayer( tech.getLayer('via12.block') )
    tech.getLayer('via23')    .setBlockageLayer( tech.getLayer('via23.block') )
    tech.getLayer('via34')   .setBlockageLayer( tech.getLayer('via34.block') )
    tech.getLayer('via45')   .setBlockageLayer( tech.getLayer('via45.block') )
    tech.getLayer('via56')   .setBlockageLayer( tech.getLayer('via56.block') )
