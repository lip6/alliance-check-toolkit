...
def _setup_techno ( coriolisTechDir ):
    ShellEnv.RDS_TECHNO_NAME   = (coriolisTechDir / 'sg13g2_vsc' / 'sg13g2.rds').as_posix()
    ShellEnv.GRAAL_TECHNO_NAME = (coriolisTechDir / 'sg13g2_vsc' / 'symbolic.graal' ).as_posix()
    ShellEnv.DREAL_TECHNO_NAME = (coriolisTechDir / 'sg13g2_vsc' / 'symbolic.dreal' ).as_posix()

    db = DataBase.getDB()
    CRL.System.get()

    tech = Technology.create(db, 'sg13g2_vsc')
