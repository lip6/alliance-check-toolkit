...
if tech:
    ...
    tech = Technology.create( DataBase.getDB(), 'sky130nsxlib' )
...
NWELL.setExtentionCap( nWell, l(6.0) )
PWELL.setExtentionCap( pWell, l(6.0) )

NTIE.setMinimalSize   (           l( 3.0) )
NTIE.setExtentionCap  ( nWell   , l( 6.0) )
NTIE.setExtentionWidth( nWell   , l( 6.0) )
NTIE.setExtentionCap  ( nImplant, l( 4.0) )
NTIE.setExtentionWidth( nImplant, l( 2.0) )
NTIE.setExtentionCap  ( active  , l( 2.0) )
NTIE.setExtentionWidth( active  , l(-2.0) )

PTIE.setMinimalSize   (           l( 3.0) )
PTIE.setExtentionCap  ( nWell   , l( 6.0) )
PTIE.setExtentionWidth( nWell   , l( 6.0) )
PTIE.setExtentionCap  ( nImplant, l( 4.0) )
PTIE.setExtentionWidth( nImplant, l( 2.0) )
PTIE.setExtentionCap  ( active  , l( 2.0) )
PTIE.setExtentionWidth( active  , l(-2.0) )

NDIF.setMinimalSize   (           l(4.0) )
NDIF.setExtentionCap  ( nImplant, l(0.0) )
NDIF.setExtentionWidth( nImplant, l(0.0) )
NDIF.setExtentionCap  ( active  , l(0.0) )
NDIF.setExtentionWidth( active  , l(0.0) )

PDIF.setMinimalSize   (           l(4.0) )
PDIF.setExtentionCap  ( pImplant, l(0.0) )
PDIF.setExtentionWidth( pImplant, l(0.0) )
PDIF.setExtentionCap  ( active  , l(0.0) )
PDIF.setExtentionWidth( active  , l(0.0) )

GATE.setMinimalSize   (           l(1.7) )
GATE.setExtentionCap  ( poly    , l(1.7) )

NTRANS.setMinimalSize   (           l( 1.7) )
NTRANS.setExtentionCap  ( nImplant, l( 0.0) )
NTRANS.setExtentionWidth( nImplant, l( 0.0) )
NTRANS.setExtentionCap  ( active  , l( 0.0) )
NTRANS.setExtentionWidth( active  , l( 0.0) )
NTRANS.setExtentionCap  ( poly    , l( 1.7) )
NTRANS.setExtentionWidth( poly    , l( -0.28) )

PTRANS.setMinimalSize   (           l( 1.7) )
PTRANS.setExtentionCap  ( nWell   , l( 0.0) )
PTRANS.setExtentionWidth( nWell   , l( 0.0) )
PTRANS.setExtentionCap  ( pImplant, l( 0.0) )
PTRANS.setExtentionWidth( pImplant, l( 0.0) )
PTRANS.setExtentionCap  ( active  , l( 0.0) )
PTRANS.setExtentionWidth( active  , l( 0.0) )
PTRANS.setExtentionCap  ( poly    , l( 1.7) )
PTRANS.setExtentionWidth( poly    , l( -0.28) )

POLY .setMinimalSize   (           l(1.7) )
POLY .setExtentionCap  ( poly    , l(0.0) )
POLY2.setMinimalSize   (           l(3.6) )
POLY2.setExtentionCap  ( poly    , l(0.0) )

# Routing Layers (symbolic).
METAL1 .setMinimalSize   (           l( 2.0) )
METAL1 .setExtentionCap  ( metal1  , l( 1.0) )
METAL1 .setExtentionWidth( metal1  , l( 0.0) )
METAL1 .setMinimalSpacing(           l( 3.0) )
METAL2 .setMinimalSize   (           l( 2.0) )
METAL2 .setExtentionCap  ( metal2  , l( 1.0) )
METAL2 .setMinimalSpacing(           l( 3.0) )
...
CONT_BODY_N.setMinimalSize(           l( 2.26) )
CONT_BODY_N.setEnclosure  ( nWell   , l( 4.0), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_N.setEnclosure  ( nImplant, l( 1.7), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_N.setEnclosure  ( active  , l( 2.0), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_N.setEnclosure  ( metal1  , l( 2.0), Layer.EnclosureH|Layer.EnclosureV )

CONT_BODY_P.setMinimalSize(           l( 2.26) )
CONT_BODY_P.setEnclosure  ( pWell   , l( 4.0), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_P.setEnclosure  ( pImplant, l( 1.7), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_P.setEnclosure  ( active  , l( 2.0), Layer.EnclosureH|Layer.EnclosureV )
CONT_BODY_P.setEnclosure  ( metal1  , l( 2.0), Layer.EnclosureH|Layer.EnclosureV )
