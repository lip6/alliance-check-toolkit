...
def scriptMain ( **kw ):
    ...
    try:
        ...
        ioPadsSpec = [ (IoPin.SOUTH, None, 'a_1'        , 'a(1)'   , 'a(1)'   , 'io_in'   )
                     , (IoPin.SOUTH, None, 'iopower_0'  , 'iovdd'  )
                     , (IoPin.SOUTH, None, 'power_0'    , 'vdd'    )
                     , (IoPin.SOUTH, None, 'a_0'        , 'a(0)'   , 'a(0)'   , 'io_in'   )
                     , (IoPin.EAST , None, 'a_2'        , 'a(2)'   , 'a(2)'   , 'io_in'   )
                     , (IoPin.EAST , None, 'a_3'        , 'a(3)'   , 'a(3)'   , 'io_in'   )
                     , (IoPin.EAST , None, 'ioground_0' , 'iovss'  )
                     , (IoPin.EAST , None, 'ground_0'   , 'vss'    )
                     , (IoPin.EAST , None, 'b_3'        , 'b(3)'   , 'b(3)'   , 'io_in'   )
                     , (IoPin.EAST , None, 'b_2'        , 'b(2)'   , 'b(2)'   , 'io_in'   )
                     , (IoPin.NORTH, None, 'ioground_1' , 'iovss'  , 'vss'    )
                     , (IoPin.NORTH, None, 'b_1'        , 'b(1)'   , 'b(1)'   , 'io_in'   )
                     , (IoPin.NORTH, None, 'b_0'        , 'b(0)'   , 'b(0)'   , 'io_in'   )
                    #, (IoPin.NORTH, None, 'ground_1'   , 'iovss'  , 'vss'    )
                     , (IoPin.NORTH, None, 'p_clock'    , 'm_clock', 'm_clock', 'io_in'   )
                     , (IoPin.NORTH, None, 'p_reset'    , 'p_reset', 'p_reset', 'io_in'   )
                     , (IoPin.NORTH, None, 'ioground_2' , 'iovss'  )
                     , (IoPin.WEST , None, 'f_3'        , 'f(3)'   , 'f(3)'   , 'io_out'  )
                     , (IoPin.WEST , None, 'f_2'        , 'f(2)'   , 'f(2)'   , 'io_out'  )
                     , (IoPin.WEST , None, 'f_1'        , 'f(1)'   , 'f(1)'   , 'io_out'  )
                     , (IoPin.WEST , None, 'f_0'        , 'f(0)'   , 'f(0)'   , 'io_out'  )
                     ]
