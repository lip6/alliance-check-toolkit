...
from coriolis.designflow.technos import setupPhenitec600

setupPhenitec600( checkToolkit='../../..' )
...
ruleYosys = Yosys   .mkRule( 'yosys', 'snx.v' )
ruleB2V   = Blif2Vst.mkRule( 'b2v'  , 'snx.vst', [ruleYosys], flags=0 )
rulePnR   = PnR     .mkRule( 'pnr'  , [ 'snx_cts_r.ap'
                                      , 'snx_cts_r.vst'
                                      , 'snx_cts_r.spi'
                                      ]
                                      , [ruleB2V]
                                    , scriptMain )
ruleCougar    = Cougar.mkRule( 'cougar', 'snx_cts_r_ext.al', [rulePnR]
...
ruleGds       = S2R   .mkRule( 'gds', 'snx_cts_r.gds', [rulePnR]
