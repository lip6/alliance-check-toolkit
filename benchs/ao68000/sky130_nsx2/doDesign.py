...
def scriptMain ( **kw ):
    ...
    try:
       ...
       #ao68000Conf.cfg.katana.vTracksReservedLocal = 9
        ao68000Conf.cfg.katana.hTracksReservedMin   = 6
        ao68000Conf.cfg.katana.vTracksReservedMin   = 5
       #ao68000Conf.cfg.katana.trackFill            = 0
        ao68000Conf.cfg.katana.runRealignStage      = True
        ao68000Conf.cfg.katana.dumpMeasures         = False
        ao68000Conf.cfg.block.spareSide             = l(8*100)
        ...
        if buildChip:
            ao68000Conf.coreSize = ( l(110*10.0          ), l(100*10.0          ) )
