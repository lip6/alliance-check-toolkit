...
Cfg.getParamPercentage( 'etesian.aspectRatio'               ).setPercentage( 70.0       )
...
Cfg.getParamInt       ( 'anabatic.globalIterationsEstimate' ).setInt       ( 6          )
Cfg.getParamInt       ( 'anabatic.globalIterations'         ).setInt       ( 22         )
...
Cfg.getParamBool      ( 'katana.useStaticBloatProfile'      ).setBool      ( False      )
Cfg.getParamInt       ( 'katana.bloatOverloadAdd'           ).setInt       ( 4          )
