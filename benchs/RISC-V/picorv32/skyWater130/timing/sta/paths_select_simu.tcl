...
set figname picorv32_m

# Simulation Config
avt_config avtSpiceString     "ngspice -b $"
avt_config SimToolModel spice
avt_config SimTool ngspice
avt_config simTechnologyName ../../../../../../pdkmaster/C4M.Sky130/libs.tech/ngspice/C4M.Sky130_logic_tt_model.spice
#avt_config simTechnologyName /users/cao/aoudrhiri/coriolis-2.x/src/alliance-check-toolkit/benchs/inverter/skyWater130/sta/techno/all_models_transistor.spice
