...
# | =============================================================== |
# |  Python      :  "./nand2group.py"                               |
# |                                                                 |
# |  Python by Marie-Minerve LOUERAT (4 April  2023)                |
...
class TWONAND2 ( AnalogDesign ):
    ...
    def build ( self, editor ):
        print( '  o  Running TWONAND2.build().')
...
def scriptMain ( **kw ):
    ...
    cell = CRL.AllianceFramework.get().getCell( 'twonand2', CRL.Catalog.State.Views )
    if cell:
        UpdateSession.open()
        cell.destroy()
        UpdateSession.close()
        print( 'Previous <twonand2> cell destroyed.')
