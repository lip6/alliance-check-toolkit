...
# | =============================================================== |
# |  Python      :  "./comparator_buffer_oceane.py"                 |
# |                                                                 |
# |  Python by Marie-Minerve LOUERAT (20 March 2023)                |
# |  Oceane sizing by Jacky PORTE    (20 March 2023)                |
# |  revision: 24 April 2023                                        |
# +-----------------------------------------------------------------+
#
#
# Comparator : Dynamic pre-amplifier (Ptype), Latch-type Song comparator (type N), output buffers
# Folded transistors
# Routing described
#
# -----------------------------------------------------------------------------
...
class COMPARATOR ( AnalogDesign ):
    ...
    def build ( self, editor ):
        print( '  o  Running COMPARATOR.build().')
       ...
       #    +=============+===========+=================+=====+========+=======+==+=====+===+======+====+=======+
        ...
        self.netSpecs = \
          ...
          , 's'      : [ ('cmpmn23', 'D'), ('cmpmp23', 'D') ]
          , 'r'      : [ ('cmpmn24', 'D'), ('cmpmp24', 'D') ]
          ...
          , 'vss'    : [ ('cmpmn7' , 'S'), ('cmpmn8' , 'S'), ('cmpmn9' , 'S'), ('cmpmn11', 'S'), ('cmpmn12', 'S') 
                       , ('cmpmn17', 'S'), ('cmpmn18', 'S'), ('cmpmn21', 'S'), ('cmpmn22', 'S'), ('cmpmn23', 'S'), ('cmpmn24', 'S')]
          }

        self.readParameters( './sizes/oceane_comparator_buffer.txt' )

        self.beginCell( 'comparator' )
        self.doDevices()
        self.doNets   ()
...
def scriptMain ( **kw ):
    ...
    cell = CRL.AllianceFramework.get().getCell( 'comparator', CRL.Catalog.State.Views )
    if cell:
        UpdateSession.open()
        cell.destroy()
        UpdateSession.close()
        print( 'Previous <comparator> cell destroyed.')
