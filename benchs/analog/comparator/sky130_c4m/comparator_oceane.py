...
#
#
# Comparator : Dynamic pre-amplifier (Ptype), Latch-type Song comparator (type N)
# Folded transistors
# Routing described
#
# -----------------------------------------------------------------------------
    ...
    def build ( self, editor ):
       ...
       #    +=============+===========+=================+=====+========+=======+==+=====+===+======+====+=======+
        ...
        self.netSpecs = \
          ...
          , 'vss'    : [ ('cmpmn7' , 'S'), ('cmpmn8' , 'S'), ('cmpmn9' , 'S'), ('cmpmn11', 'S'), ('cmpmn12', 'S'), ('cmpmn17', 'S'), ('cmpmn18', 'S')]
          }

        self.readParameters( './sizes/oceane_comparator.txt' )
