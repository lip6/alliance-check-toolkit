...
%}
 ...
 \newcommand{\DUadmonitionnote}[1]{%
   \begin{center}
     ...
     \begin{array}[t]{m{1cm}!{\vrule width 1pt}m{.90\textwidth}}
       \raisebox{0.0cm}{\includegraphics[scale=0.5]{./images/clipboard.pdf}} &
 ...
 \newcommand{\DUadmonitionerror}[1]{%
   \begin{center}
     \sffamily
     \begin{array}[t]{m{1cm}!{\vrule width 1pt}m{.90\textwidth}}
       \raisebox{0.0cm}{\includegraphics[scale=0.5]{./images/i-core.pdf}} &
       \begin{minipage}[t]{.85\textwidth} #1
       \end{minipage} \\
     \end{array}
   \end{center}
 ...
 \lhead[]{\textsc{Readme} for Toolkit Checker}
 \rhead[]{\today}
 \lfoot[]{\UPMC/\LIP}
 \rfoot[]{\thepage}
 \cfoot[]{}
