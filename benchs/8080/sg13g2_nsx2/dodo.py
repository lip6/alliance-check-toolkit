...
pnrcheck.mkRuleSet( globals(), 'my80core', pnrcheck.UseClockTree )
#pnrcheck.mkRuleSet( globals(), 'my80core')
#ruleGds = S2R.mkRule( 'gds', 'my80core_cts_r.gds', 'my80core_cts_rdder_r.ap'
#                    , flags=S2R.Verbose|S2R.NoReplaceBlackboxes )
#ruleDRC = DRC.mkRule( 'drc', 'my80core_cts_r.gds' )
