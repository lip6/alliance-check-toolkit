    ...
    try:
       ...
       #Breakpoint.setStopLevel( 100 )
        ...
        ioPadsSpec = [ (IoPin.WEST , None, 'iopower_0'  , 'iovdd'  )
                     ...
                     , (IoPin.WEST , None, 'ioground_1' , 'iovss'  )
                     , (IoPin.WEST , None, 'iopower_1'  , 'iovdd'  )

                     , (IoPin.SOUTH, None, 'iopower_2'  , 'iovdd'  )
                     , (IoPin.SOUTH, None, 'ioground_2' , 'iovss'  )
                     ...
                     , (IoPin.SOUTH, None, 'ioground_3' , 'iovss'  )

                     , (IoPin.EAST , None, 'iopower_4'  , 'iovdd'  )
                     , (IoPin.EAST , None, 'ioground_4' , 'iovss'  )
                     ...
                     , (IoPin.EAST , None, 'ioground_5' , 'iovss'  )
                     , (IoPin.EAST , None, 'iopower_5'  , 'iovdd'  )

                     , (IoPin.NORTH, None, 'iopower_6'  , 'iovdd'  )
                     , (IoPin.NORTH, None, 'ioground_6' , 'iovss'  )
                     ...
                     , (IoPin.NORTH, None, 'ioground_7' , 'iovss'  )
