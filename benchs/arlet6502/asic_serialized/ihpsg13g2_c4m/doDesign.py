...
def scriptMain ( **kw ):
    ...
    try:
        ...
        cell = af.getCell( 'serialized_arlet6502', CRL.Catalog.State.Logical )
        if not cell:
            cell = CRL.Blif.load( 'serialized_arlet6502' )
        if editor:
            editor.setCell( cell ) 
        ...
        ioPinsSpec = [ (IoPin.WEST |IoPin.A_BEGIN, 'DI({})'  ,    pinSpacing, pinSpacing,  8)
                     ...
                     , (IoPin.EAST |IoPin.A_BEGIN, 'lh({})'   ,   pinSpacing, pinSpacing,  3)
       ...
       #conf.cfg.anabatic.searchHalo         = 2
        ...
        conf.coreSize            = conf.computeCoreSize( 80*conf.sliceHeight, 1.0 )
       #conf.coreSize            = (  280*sliceStep,  80*sliceHeight )
