...
if buildChip:
    ...
    rulePnR   = PnR.mkRule( 'gds'  , [ 'chip_r.gds'
                                     ...
                                     , 'corona.vst'
                                     , 'corona.spi'
                                     , 'serialized_arlet6502_cts.spi'
                                     , 'serialized_arlet6502_cts.vst' ]
                                     , [ruleB2V, ruleSeal]
                                   , scriptMain
                                   , topName=topName )
    ...
    rulePnR = PnR.mkRule( 'gds'    , [ 'serialized_arlet6502_cts_r.gds'
                                     , 'serialized_arlet6502_cts_r.vst'
                                     , 'serialized_arlet6502_cts_r.spi' ]
                                     , [ruleB2V]
                                   , scriptMain
                                   , topName=topName )
    ruleX2Y = x2y.mkRule( 'spi2vst', 'serialized_arlet6502_cts_r_spi.vst', 'serialized_arlet6502_cts_r.spi' )
    ruleLvx = Lvx.mkRule( 'lvx_spi', [ 'serialized_arlet6502_cts_r.vst'
                                     , 'serialized_arlet6502_cts_r.spi' ]
    ...
    ruleIverilog = Iverilog.mkRule( 'iverilog', [ ruleVasy, 'gate_serialized_arlet6502_tb_cpu.v' ] )
