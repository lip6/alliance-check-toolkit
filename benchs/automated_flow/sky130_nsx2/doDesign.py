...
def scriptMain ( **kw ):
    dico = get_signals_hurricane("mac")
    ...
    try:
       ...
       #Breakpoint.setStopLevel( 100 )
        ...
        if buildChip:
            ...
            m1pitch    = l(10.0)  # a diviser par 2 pour lsx
            m2pitch    = l(10.0)
            ioPadsSpec = [ ]
            h,v= (42*l(100.0), 42*l(100.0) )
            L = generate_ioPinsSpec_list(dico,h,v,m2pitch,m1pitch)
            M =[]
       ...
       #conf.cfg.katana.vTracksReservedMin   = 1
        ...
        conf.bRows               = 2
        conf.chipName            = 'chip'
        conf.coreSize            = ( 44*l(100.0), 44*l(100.0) )
