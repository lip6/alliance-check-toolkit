    ...
    try:
       ...
       #Breakpoint.setStopLevel( 100 )
        ...
        if buildChip:
            ...
            m2pitch    = u(0.51)
            ioPadsSpec = [ ]
            ioPinsSpec 	= [(18, 'trace_data({})', 91800, 91800, range(0, 36)), (18, 'mem_la_wdata({})', 3396600, 91800, range(0, 32)), (18, 'mem_la_addr({})', 6334200, 91800, range(0, 32)), (17, 'eoi({})', 91800, 91800, range(0, 32)), (17, 'mem_addr({})', 3029400, 91800, range(0, 32)), (17, 'mem_wdata({})', 5967000, 91800, range(0, 32)), (17, 'mem_rdata({})', 8904600, 91800, range(0, 4)), (20, 'mem_rdata({})', 92000, 92000, range(4, 32)), (20, 'irq({})', 2668000, 92000, range(0, 32)), (20, 'pcpi_insn({})', 5612000, 92000, range(0, 32)), (20, 'pcpi_rs1({})', 8556000, 92000, range(0, 8)), (24, 'pcpi_rs1({})', 92000, 92000, range(8, 32)), (24, 'pcpi_rd({})', 2300000, 92000, range(0, 32)), (24, 'pcpi_rs2({})', 5244000, 92000, range(8, 32)), (24, 'mem_wstrb({})', 7452000, 92000, range(0, 4)), (24, 'mem_la_wstrb({})', 7820000, 92000, range(0, 4)), (24, 'mem_la_write', 8188000, 0, range(0, 1)), (24, 'trap', 8280000, 0, range(0, 1)), (24, 'resetn', 8372000, 0, range(0, 1)), (24, 'mem_instr', 8464000, 0, range(0, 1)), (24, 'mem_valid', 8556000, 0, range(0, 1)), (24, 'mem_la_read', 8648000, 0, range(0, 1)), (24, 'pcpi_wr', 8740000, 0, range(0, 1)), (24, 'pcpi_wait', 8832000, 0, range(0, 1)), (24, 'trace_valid', 8924000, 0, range(0, 1)), (24, 'mem_ready', 9016000, 0, range(0, 1)), (24, 'clk', 9108000, 0, range(0, 1)), (24, 'pcpi_valid', 9200000, 0, range(0, 1)), (24, 'pcpi_ready', 9292000, 0, range(0, 1))]
