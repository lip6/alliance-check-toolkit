    ...
    try:
       ...
       #Breakpoint.setStopLevel( 100 )
        ...
        if buildChip:
            ...
            m2pitch    = u(0.51)
            ioPadsSpec = [ ]
            ioPinsSpec 	= [(18, 'trace_data({})', 163200, 163200, range(0, 36)), (18, 'mem_la_wdata({})', 6038400, 163200, range(0, 32)), (18, 'mem_la_addr({})', 11260800, 163200, range(0, 32)), (17, 'eoi({})', 163200, 163200, range(0, 32)), (17, 'mem_addr({})', 5385600, 163200, range(0, 32)), (17, 'mem_wdata({})', 10608000, 163200, range(0, 32)), (17, 'mem_rdata({})', 15830400, 163200, range(0, 4)), (20, 'mem_rdata({})', 165600, 165600, range(4, 32)), (20, 'irq({})', 4802400, 165600, range(0, 32)), (20, 'pcpi_insn({})', 10101600, 165600, range(0, 32)), (20, 'pcpi_rs1({})', 15400800, 165600, range(0, 8)), (24, 'pcpi_rs1({})', 165600, 165600, range(8, 32)), (24, 'pcpi_rd({})', 4140000, 165600, range(0, 32)), (24, 'pcpi_rs2({})', 9439200, 165600, range(8, 32)), (24, 'mem_wstrb({})', 13413600, 165600, range(0, 4)), (24, 'mem_la_wstrb({})', 14076000, 165600, range(0, 4)), (24, 'mem_la_write', 14738400, 0, range(0, 1)), (24, 'trap', 14904000, 0, range(0, 1)), (24, 'resetn', 15069600, 0, range(0, 1)), (24, 'mem_instr', 15235200, 0, range(0, 1)), (24, 'mem_valid', 15400800, 0, range(0, 1)), (24, 'mem_la_read', 15566400, 0, range(0, 1)), (24, 'pcpi_wr', 15732000, 0, range(0, 1)), (24, 'pcpi_wait', 15897600, 0, range(0, 1)), (24, 'trace_valid', 16063200, 0, range(0, 1)), (24, 'mem_ready', 16228800, 0, range(0, 1)), (24, 'clk', 16394400, 0, range(0, 1)), (24, 'pcpi_valid', 16560000, 0, range(0, 1)), (24, 'pcpi_ready', 16725600, 0, range(0, 1))]
