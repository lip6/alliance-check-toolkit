    ...
    try:
       ...
       #Breakpoint.setStopLevel( 100 )
        ...
        if buildChip:
            ...
            ioPinsSpec 	=[(IoPin.NORTH |IoPin.A_BEGIN, "trace_data({})",20*m2pitch,20*m2pitch,range(0,36)),
	(IoPin.NORTH |IoPin.A_BEGIN, "mem_la_wdata({})",(1+36)*20 *m2pitch,20*m2pitch,range(0,32)),
	(IoPin.NORTH |IoPin.A_BEGIN, "mem_la_addr({})",(1+68)*20 *m2pitch,20*m2pitch,range(0,32)),
	(IoPin.SOUTH |IoPin.A_BEGIN, "eoi({})",20*m2pitch,20*m2pitch,range(0,32)),
	(IoPin.SOUTH |IoPin.A_BEGIN, "mem_addr({})",(1+32)*20 *m2pitch,20*m2pitch,range(0,32)),
	(IoPin.SOUTH |IoPin.A_BEGIN, "mem_wdata({})",(1+64)*20 *m2pitch,20*m2pitch,range(0,32)),
	(IoPin.SOUTH |IoPin.A_BEGIN, "mem_rdata({})",(1+96)*20 *m2pitch,20*m2pitch,range(0,4)),
	(IoPin.EAST |IoPin.A_BEGIN, "mem_rdata({})",22*m1pitch,22*m1pitch,range(4,32)),
	(IoPin.EAST |IoPin.A_BEGIN, "irq({})",(1+28)*22 *m1pitch,22*m1pitch,range(0,32)),
	(IoPin.EAST |IoPin.A_BEGIN, "pcpi_insn({})",(1+60)*22 *m1pitch,22*m1pitch,range(0,32)),
	(IoPin.EAST |IoPin.A_BEGIN, "pcpi_rs1({})",(1+92)*22 *m1pitch,22*m1pitch,range(0,8)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_rs1({})",22*m1pitch,22*m1pitch,range(8,32)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_rd({})",(1+24)*22 *m1pitch,22*m1pitch,range(0,32)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_rs2({})",(1+56)*22 *m1pitch,22*m1pitch,range(8,32)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_wstrb({})",(1+80)*22 *m1pitch,22*m1pitch,range(0,4)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_la_wstrb({})",(1+84)*22 *m1pitch,22*m1pitch,range(0,4)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_la_write",(1+88)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "trap",(1+89)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "resetn",(1+90)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_instr",(1+91)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_valid",(1+92)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_la_read",(1+93)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_wr",(1+94)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_wait",(1+95)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "trace_valid",(1+96)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "mem_ready",(1+97)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "clk",(1+98)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_valid",(1+99)*22 *m1pitch,0,range(0,1)),
	(IoPin.WEST |IoPin.A_BEGIN, "pcpi_ready",(1+100)*22 *m1pitch,0,range(0,1))]
    print('#############################################################################')
