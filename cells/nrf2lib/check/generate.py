...
if __name__ == '__main__':
  ...
  if modelName.startswith( 'block_rf2r0' ):
    cell = stratus.buildModel( 'dpgen_RF2'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf2r0'
                             , modelName = modelName
                             , parameters={ 'nbit'     : options.bits
                                          , 'nword'    : options.words
                                          , 'logical'  : True
  ...
  elif modelName.startswith( 'block_rf2d' ):
    cell = stratus.buildModel( 'dpgen_RF2'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf2d'
                             , modelName = modelName
  ...
  elif modelName.startswith( 'block_rf2' ):
    cell = stratus.buildModel( 'dpgen_RF2'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf2'
                             , modelName = modelName
