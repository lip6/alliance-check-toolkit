...
coreToChip = None
if technoName == 'cmos':       import plugins.core2chip_cmos
if technoName == 'c35b4':      import plugins.core2chip_c35b4
if technoName == 'phenitec06': import plugins.core2chip_phlib80
    ...
    try:
        ...
        if doStages & DoPlacement:
            if doStages & DoChip:
               ...
               #  cts.clocktree.computeAbutmentBox( cell, spaceMargin, aspectRatio, cellGauge )
